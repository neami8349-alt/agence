...
export default function BlogHighlight({
  ...
  return (
    ...
    >
      ...
      {/* Image */}
      <figure className="flex-[0_0_100%] order-[-1] min-[60rem]:order-0 min-[60rem]:flex-[0_0_50%] relative overflow-hidden rounded-[0.96rem] pb-[60%] min-[60rem]:pb-[60.9%] min-[60rem]:my-[6.4rem] m-0">
        <a href={href} className="absolute inset-0">
          <picture className="absolute inset-0">
            ...
            <img
              alt={imageAlt}
              src={imageSrc}
              className="absolute inset-0 w-full h-full object-cover transition-opacity duration-300 rounded-[0.96rem]"
            />
          </picture>
        </a>
      </figure>
