    ...
    <div className="min-h-screen bg-background">
      ...
      <ArticleWrapper>
        <ArticleHero 
          ...
          alt="The Future of Creative Technology"
        />

        <div className="box-content max-w-[86.25rem] px-4 md:px-[calc(18vw-6.25rem)] mx-auto mt-8">
          <Link to="/blog" className="inline-flex items-center text-sm font-medium text-muted-foreground hover:text-foreground transition-colors group">
