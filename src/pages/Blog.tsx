            ...
            {articles.map((article, index) => (
              ...
              >
                <article className="h-full">
                  ...
                  <span className="inline-block px-[0.2em] py-[0.1em] text-[1.2rem] uppercase text-center text-transparent border-b-[0.15em] border-solid border-b-transparent bg-gradient-to-r from-[#8d49f7] to-[#6b53ff] bg-clip-text mb-3 hover:border-b-[#8d49f7] transition-colors">
                    {article.tag}
                  </span>
